...
// Framework setting
#define _DIST_TARGET 245    // [20213085] 정지하려는 위치 목표값
#define _DIST_MIN 100         //[20191979] 최소거리
#define _DIST_MAX 410         //[20191979] 최대거리

// Distance sensor
#define _DIST_ALPHA 0.15 //[20203118] DIST_ALPHA 값 설정

// Servo range
#define _DUTY_MIN 1100    // [20213083]서보 각도의 최솟값 설정
#define _DUTY_NEU 1460    // [20213090]서보 수평 각도 펄스 값
#define _DUTY_MAX 1760        // [20213081] 서보 각도의 최댓값

// Servo speed control
#define _SERVO_ANGLE 30 //[20203118] 최대 가동범위에 따른 목표 서보 회전각
#define _SERVO_SPEED 500 //[20203118] 서보 속도 설정
...
// PID parameters
#define _KP 1.8        //[20191979] 비례제어 값
#define _KD 81        // 미분제어 값
#define _KI 0.004        // 적분제어 값
